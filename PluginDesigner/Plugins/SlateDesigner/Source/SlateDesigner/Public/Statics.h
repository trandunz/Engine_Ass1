...
inline TSharedRef<SHorizontalBox> Statics::CreateNewTitle(FString _title)
{
...
template<class T>
inline TSharedRef<SHorizontalBox> Statics::CreateNamedInputField(T* _this, FString _name, TDelegate<void(const FText&)>::TMethodPtr<T> _onNameChanged)
{
	return SNew(SHorizontalBox)
		+SHorizontalBox::Slot()
		.VAlign(VAlign_Top)
...
template <class T>
inline TSharedRef<SHorizontalBox> Statics::CreateNamedButton(T* _this, FString _name,
...
inline TSharedRef<SHorizontalBox> Statics::CreateBlueprintPicker(FString _name, UClass* _filter,
...
template <class T>
inline TSharedRef<SHorizontalBox> Statics::CreateVectorInputField(T* _this, FString _name,
	TDelegate<TOptional<double>()>::TConstMethodPtr<T> _getXFunc,
	TDelegate<TOptional<double>()>::TConstMethodPtr<T> _getYFunc,
	TDelegate<TOptional<double>()>::TConstMethodPtr<T> _getZFunc,
	TDelegate<void(double)>::TMethodPtr<T, ETextCommit::Type, int, EAxisList::Type, bool> _onChanged,
...
template <class T>
inline TSharedRef<SHorizontalBox> Statics::CreateButton(T* _this, FString _text, TDelegate<void()>::TMethodPtr<T> _onPressed)
{
	return SNew(SHorizontalBox)
		+SHorizontalBox::Slot()
		.HAlign(HAlign_Center)
...
inline FSlateColor Statics::GetRowBackgroundColor(int32 IndentLevel, bool IsHovered)
{
	int32 ColorIndex = 0;
	int32 Increment = 1;
